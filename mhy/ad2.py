"""
  ...
  @Project : mirror
  @File    : ad.py
  @Function: Aggregation network for classify branch and Context Guided Decoder network for mask prediction branch.
             This is the version which came up with on Mid-Autumn Festival.
...
def fpn_classifier_graph_first(rois, feature_maps, image_meta,
    ...
    return mrcnn_class_logits, mrcnn_probs, mrcnn_bbox, aggregation
...
def fpn_classifier_graph_second(rois, feature_maps, image_meta,
    ...
    # Shape: [batch, num_boxes, pool_height, pool_width, channels]
    # each box is a time step. Independent with each other.
    fusion_edge = PyramidROIAlign_classify_edge(pool_size[0], name="pyramid_roi_classify_edge_second")(
        [rois, image_meta] + feature_maps)
    fusion_content = PyramidROIAlign_classify_content(pool_size[1], name="pyramid_roi_classify_content_second")(
        [rois, image_meta] + feature_maps)
    fusion_context = PyramidROIAlign_classify_context(pool_size[3], name="pyramid_roi_classify_context_second")(
        [rois, image_meta] + feature_maps)

    # ################ Edge Module #########################
    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", strides=2, activation="relu"),
                           name="edge_class_conv1_second")(fusion_edge)
    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", strides=2, activation="relu"),
                           name="edge_class_conv2_second")(x)

    x = KL.TimeDistributed(KL.Conv2D(2048, (7, 7), padding="valid", activation="relu"),
                           name="edge_class_conv3_second")(x)
    edge_1024 = KL.TimeDistributed(KL.Conv2D(1024, (1, 1), padding="valid", activation="relu"),
                           name="edge_class_conv4_second")(x)

    # ################ Content Module #########################
    y = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", strides=2, activation="relu"),
                           name="content_class_conv1_second")(fusion_content)
    y = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", strides=1, activation="relu"),
                           name="content_class_conv2_second")(y)

    y = KL.TimeDistributed(KL.Conv2D(2048, (7, 7), padding="valid", activation="relu"),
                           name="content_class_conv3_second")(y)
    content_1024 = KL.TimeDistributed(KL.Conv2D(1024, (1, 1), padding="valid", activation="relu"),
                           name="content_class_conv4_second")(y)

    # ################ Context Module #########################
    z = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", strides=1, activation="relu"),
                           name="context_class_conv1_second")(fusion_context)
    z = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", strides=1, activation="relu"),
                           name="context_class_conv2_second")(z)

    z = KL.TimeDistributed(KL.Conv2D(2048, (7, 7), padding="valid", activation="relu"),
                           name="context_class_conv3_second")(z)
    context_1024 = KL.TimeDistributed(KL.Conv2D(1024, (1, 1), padding="valid", activation="relu"),
                           name="context_class_conv4_second")(z)
...
def build_fpn_mask_graph(rois, feature_maps, aggregation, image_meta,
                         pool_size, num_classes, train_bn=True):
    ...
    N2_pooled = PyramidROIAlign_mask(pool_size[0], 0, name="pyramid_roi_align_mask_n2")(
        [rois, image_meta] + feature_maps)
    N3_pooled = PyramidROIAlign_mask(pool_size[1], 1, name="pyramid_roi_align_mask_n3")(
        [rois, image_meta] + feature_maps)
    N4_pooled = PyramidROIAlign_mask(pool_size[2], 2, name="pyramid_roi_align_mask_n4")(
        [rois, image_meta] + feature_maps)
    N5_pooled = PyramidROIAlign_mask(pool_size[3], 3, name="pyramid_roi_align_mask_n5")(
        [rois, image_meta] + feature_maps)

    print(N2_pooled, N3_pooled, N4_pooled, N5_pooled)
    ...
    x = KL.Add(name="decoder_mask_n5add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (4, 4), strides=4),
                           name="decoder_mask_sharedupsampled")(x),
    ...
    x = KL.Add(name="decoder_mask_n4add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_mask_n4upsampled")(x),
    ...
    x = KL.Add(name="decoder_mask_n3add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_mask_n3upsampled")(x),
    ...
    x = KL.Add(name="decoder_mask_n2add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_mask_n2upsampled")(x),
    ...
    x = KL.TimeDistributed(KL.Conv2D(num_classes, (3, 3), padding="same"),
                           name="decoder_mask_64x64x2")(x)
    # aggregation
    # shape [batch, box, 1, 1, 2*64*64]
    y = KL.TimeDistributed(KL.Conv2D(num_classes * 64 * 64, (1, 1), padding="valid", activation="relu"),
                           name="decoder_mask_aggregation_1x1xc")(aggregation)
    s = K.int_shape(y)
    # shape [batch, box, 64, 64, 2]
    y = KL.Reshape((s[1], 64, 64, num_classes), name="decoder_mask_aggregation_64x64x2")(y)

    # Add for output final mask
    z = KL.Add(name="decoder_mask_z")([x, y])
    final_mask = KL.Activation("sigmoid")(z)
...
class Ad2(object):
    """Encapsulates the Ad model functionality.
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            mrcnn_class_logits, mrcnn_class, mrcnn_bbox, aggregation = \
                fpn_classifier_graph_first(rois, class_feature_maps, input_image_meta,
                                           config.CLASSIFY_POOL_SIZE, config.NUM_CLASSES,
                                           train_bn=config.TRAIN_BN)

            mrcnn_mask = build_fpn_mask_graph(rois, mask_feature_maps, aggregation,
                                              input_image_meta,
            ...
            mrcnn_class_logits, mrcnn_class, mrcnn_bbox, aggregation_first = \
                fpn_classifier_graph_first(rpn_rois, rpn_feature_maps, input_image_meta,
                                           config.CLASSIFY_POOL_SIZE, config.NUM_CLASSES,
                                           train_bn=config.TRAIN_BN)
            print(aggregation_first)
            # Detections
            ...
            aggregation = fpn_classifier_graph_second(detection_boxes, class_feature_maps, input_image_meta,
                                                 config.CLASSIFY_POOL_SIZE, config.NUM_CLASSES,
                                                 train_bn=config.TRAIN_BN)

            mrcnn_mask = build_fpn_mask_graph(detection_boxes, mask_feature_maps, aggregation,
                                              input_image_meta,
                                              config.MASK_POOL_SIZE,
                                              config.NUM_CLASSES,
                                              train_bn=config.TRAIN_BN)
