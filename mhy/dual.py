"""
  ...
  @Project : mirror
  @File    : c26dm.py
  @Function: context_12-34-6 + dual path segmentation.
...
def fpn_classifier_graph(rois, feature_maps, image_meta,
    ...
    # #################### Low Level ########################
    low = KL.Lambda(lambda a: K.concatenate(a, axis=4), name="low_level")([n2_pooled, n3_pooled])
    low_fc = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                                name="context_low_fc")(low)

    # #################### High Level ########################
    high = KL.Lambda(lambda a: K.concatenate(a, axis=4), name="high_level")([n4_pooled, n5_pooled])
    high_fc = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                                name="context_high_fc")(high)

    # #################### Global level ######################
    global_fc = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                                name="context_global_fc")(n6_pooled)

    # Concate fc and conv to 1024
    x = KL.Lambda(lambda a: K.concatenate(a, axis=4), name="context_concat")([low_fc, high_fc, global_fc])
    print(x)
    x = KL.TimeDistributed(KL.Conv2D(1024, (1, 1), padding="valid", activation="relu"), name="context_conv")(x)
...
def build_fpn_mask_graph(rois, feature_maps, image_meta,
    ...
    n2_pooled = PyramidROIAlign(pool_size[0], 0, name="pyramid_roi_align_mask_n2")([rois, image_meta] + feature_maps)
    n3_pooled = PyramidROIAlign(pool_size[1], 1, name="pyramid_roi_align_mask_n3")([rois, image_meta] + feature_maps)
    n4_pooled = PyramidROIAlign(pool_size[2], 2, name="pyramid_roi_align_mask_n4")([rois, image_meta] + feature_maps)
    n5_pooled = PyramidROIAlign(pool_size[3], 3, name="pyramid_roi_align_mask_n5")([rois, image_meta] + feature_maps)

    # #################### High to Low ########################
    # n5 to n4
    a = KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2, activation="relu"),
                           name="decoder_low_n5up")(n5_pooled)
    a = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="relu"),
                           name="decoder_low_n5_1x1")(a)
    a = KL.TimeDistributed(KL.Conv2D(128, (3, 3), padding="same", activation="relu"),
                           name="decoder_low_n5_3x3")(a)
    a = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="sigmoid"),
                           name="decoder_low_n5_1x1_sigmoid")(a)
    a = KL.Multiply()([a, KL.TimeDistributed(copy_layer())(n4_pooled)])
    a = KL.Add()([a, KL.TimeDistributed(copy_layer())(n4_pooled)])

    # n4 to n3
    a = KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2, activation="relu"),
                           name="decoder_low_n4up")(a)
    a = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="relu"),
                           name="decoder_low_n4_1x1")(a)
    a = KL.TimeDistributed(KL.Conv2D(128, (3, 3), padding="same", activation="relu"),
                           name="decoder_low_n4_3x3")(a)
    a = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="sigmoid"),
                           name="decoder_low_n4_1x1_sigmoid")(a)
    a = KL.Multiply()([a, KL.TimeDistributed(copy_layer())(n3_pooled)])
    a = KL.Add()([a, KL.TimeDistributed(copy_layer())(n3_pooled)])

    # n3 to n2
    a = KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2, activation="relu"),
                           name="decoder_low_n3up")(a)
    a = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="relu"),
                           name="decoder_low_n3_1x1")(a)
    a = KL.TimeDistributed(KL.Conv2D(128, (3, 3), padding="same", activation="relu"),
                           name="decoder_low_n3_3x3")(a)
    a = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="sigmoid"),
                           name="decoder_low_n3_1x1_sigmoid")(a)
    a = KL.Multiply()([a, KL.TimeDistributed(copy_layer())(n2_pooled)])
    low = KL.Add()([a, KL.TimeDistributed(copy_layer())(n2_pooled)])

    # #################### Low to High ########################
    # n2 to n3
    b = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="relu"),
                           name="decoder_high_n2_1x1")(n2_pooled)
    b = KL.TimeDistributed(KL.Conv2D(128, (3, 3), padding="same", activation="relu"),
                           name="decoder_high_n2_3x3")(b)
    b = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="sigmoid"),
                           name="decoder_high_n2_1x1_sigmoid")(b)
    n3_up = KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2, activation="relu"),
                           name="decoder_high_n3up")(n3_pooled)
    b = KL.Multiply()([b, n3_up])
    b = KL.Add()([b, n3_up])

    # n3 to n4
    b = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="relu"),
                           name="decoder_high_n3_1x1")(b)
    b = KL.TimeDistributed(KL.Conv2D(128, (3, 3), padding="same", activation="relu"),
                           name="decoder_high_n3_3x3")(b)
    b = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="sigmoid"),
                           name="decoder_high_n3_1x1_sigmoid")(b)
    n4_up = KL.TimeDistributed(KL.Conv2DTranspose(256, (4, 4), strides=4, activation="relu"),
                               name="decoder_high_n4up")(n4_pooled)
    b = KL.Multiply()([b, n4_up])
    b = KL.Add()([b, n4_up])

    # n4 to n5
    b = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="relu"),
                           name="decoder_high_n4_1x1")(b)
    b = KL.TimeDistributed(KL.Conv2D(128, (3, 3), padding="same", activation="relu"),
                           name="decoder_high_n4_3x3")(b)
    b = KL.TimeDistributed(KL.Conv2D(256, (1, 1), padding="same", activation="sigmoid"),
                           name="decoder_high_n4_1x1_sigmoid")(b)
    n5_up = KL.TimeDistributed(KL.Conv2DTranspose(256, (8, 8), strides=8, activation="relu"),
                               name="decoder_high_n5up")(n5_pooled)
...
class DUAL(object):
    """Encapsulates the DUAL model functionality.
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            model = KM.Model(inputs, outputs, name='DUAL')
