...
def unmold_edge(edge, bbox, image_shape):
    """Converts a edge generated by the neural network to a format similar
    to its original shape.
    edge: [height, width] of type float. A small, typically 32x32 mask.
    bbox: [y1, x1, y2, x2]. The box to fit the edge in.
