"""
  ...
  @Project : mirror
  @File    : c26de.py
  @Function: context_2-6 + decoder_mask + decoder_edge. To prove that mask and edge branch can both boost
             the accuracy of detection through affect shared features.
...
def detection_targets_graph(proposals, gt_class_ids, gt_boxes, gt_masks, gt_edge, config):
    ...
    edge = tf.pad(edge, [[0, N + P], (0, 0), (0, 0)])

    return rois, roi_gt_class_ids, deltas, masks, edge
...
class DetectionTargetLayer(KE.Layer):
    ...
    def call(self, inputs):
        ...
        names = ["rois", "target_class_ids", "target_bbox", "target_mask", "target_edge"]
        outputs = utils.batch_slice(
            [proposals, gt_class_ids, gt_boxes, gt_masks, gt_edge],
            lambda w, x, y, z, e: detection_targets_graph(
                w, x, y, z, e, self.config),
    ...
    def compute_output_shape(self, input_shape):
        return [
            ...
            (None, self.config.TRAIN_ROIS_PER_IMAGE, self.config.EDGE_SHAPE[0],
             self.config.EDGE_SHAPE[1])  # edge
        ]
...
def fpn_classifier_graph(rois, feature_maps, image_meta,
    ...
    n2_pooled = PyramidROIAlign(pool_size, 0, name="pyramid_roi_align_n2")([rois, image_meta] + feature_maps)
    n3_pooled = PyramidROIAlign(pool_size, 1, name="pyramid_roi_align_n3")([rois, image_meta] + feature_maps)
    n4_pooled = PyramidROIAlign(pool_size, 2, name="pyramid_roi_align_n4")([rois, image_meta] + feature_maps)
    n5_pooled = PyramidROIAlign(pool_size, 3, name="pyramid_roi_align_n5")([rois, image_meta] + feature_maps)

    # Fuse gird features of different level.
    n2_fc = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                               name="context_n2pooling")(n2_pooled)
    n3_fc = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                               name="context_n3pooling")(n3_pooled)
    n4_fc = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                               name="context_n4pooling")(n4_pooled)
    n5_fc = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                               name="context_n5pooling")(n5_pooled)

    x = KL.Add(name="n2_5_fusion")([n2_fc, n3_fc, n4_fc, n5_fc])

    # global information
    n6_pooled = PyramidROIAlign(pool_size, 4, name="pyramid_roi_align_n6")([rois, image_meta] + feature_maps)

    y = KL.TimeDistributed(KL.Conv2D(1024, (pool_size, pool_size), padding="valid", activation="relu"),
                           name="context_n6pooling")(n6_pooled)
    # combine x and y
    z = KL.Lambda(lambda a: K.concatenate(a, axis=4), name="context_concat")([x, y])
    print(z)
    z = KL.TimeDistributed(KL.Conv2D(1024, (1, 1), padding="valid", activation="relu"), name="context_conv")(z)

    # squeezed shape : [batch, num_boxes, 1024]
    squeezed = KL.Lambda(lambda xx: K.squeeze(K.squeeze(xx, 3), 2), name="pool_squeeze")(z)
...
def build_fpn_mask_graph(rois, feature_maps, image_meta,
    ...
    n2_pooled = PyramidROIAlign(pool_size[0], 0, name="pyramid_roi_align_mask_n2")(
        [rois, image_meta] + feature_maps)
    n3_pooled = PyramidROIAlign(pool_size[1], 1, name="pyramid_roi_align_mask_n3")(
        [rois, image_meta] + feature_maps)
    n4_pooled = PyramidROIAlign(pool_size[2], 2, name="pyramid_roi_align_mask_n4")(
        [rois, image_meta] + feature_maps)
    n5_pooled = PyramidROIAlign(pool_size[3], 3, name="pyramid_roi_align_mask_n5")(
        [rois, image_meta] + feature_maps)

    # Names below refer to a TimeDistributed object.
    # fc
    x = KL.TimeDistributed(KL.Conv2D(1024, (4, 4), strides=4, activation="relu"),
                           name="decoder_mask_fc")(n5_pooled)
    # 4x4
    x = KL.Add(name="decoder_mask_n5add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (4, 4), strides=4),
                           name="decoder_mask_fcupscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_mask_n5pooled")(n5_pooled)
    ])
    x = KL.Activation("relu")(x)

    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", activation="relu"),
                           name="decoder_mask_n5conv")(x)
    # 8x8
    x = KL.Add(name="decoder_mask_n4add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_mask_n4upscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_mask_n4pooled")(n4_pooled)
    ])
    x = KL.Activation("relu")(x)

    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", activation="relu"),
                           name="decoder_mask_n4conv")(x)
    # 16x16
    x = KL.Add(name="decoder_mask_n3add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_mask_n3upscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_mask_n3pooled")(n3_pooled)
    ])
    x = KL.Activation("relu")(x)

    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", activation="relu"),
                           name="decoder_mask_n3conv")(x)
    # 32x32
    x = KL.Add(name="decoder_mask_n2add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_mask_n2upscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_mask_n2pooled")(n2_pooled)
    ])
    x = KL.Activation("relu")(x)

    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", activation="relu"),
                           name="decoder_mask_n2conv")(x)
    # final mask
    x = KL.TimeDistributed(KL.Conv2D(num_classes, (3, 3), padding="same", activation="sigmoid"),
                           name="decoder_mask_32x32x2")(x)
...
def build_fpn_edge_graph(rois, feature_maps, image_meta,
    ...
    n2_pooled = PyramidROIAlign(pool_size[0], 0, name="pyramid_roi_align_edge_n2")(
        [rois, image_meta] + feature_maps)
    n3_pooled = PyramidROIAlign(pool_size[1], 1, name="pyramid_roi_align_edge_n3")(
        [rois, image_meta] + feature_maps)
    n4_pooled = PyramidROIAlign(pool_size[2], 2, name="pyramid_roi_align_edge_n4")(
        [rois, image_meta] + feature_maps)
    n5_pooled = PyramidROIAlign(pool_size[3], 3, name="pyramid_roi_align_edge_n5")(
        [rois, image_meta] + feature_maps)

    # Names below refer to a TimeDistributed object.
    # fc
    x = KL.TimeDistributed(KL.Conv2D(1024, (4, 4), strides=4, activation="relu"),
                           name="decoder_edge_fc")(n5_pooled)
    # 4x4
    x = KL.Add(name="decoder_edge_n5add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (4, 4), strides=4),
                           name="decoder_edge_fcupscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_edge_n5pooled")(n5_pooled)
    ])
    x = KL.Activation("relu")(x)

    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", activation="relu"),
                           name="decoder_edge_n5conv")(x)
    # 8x8
    x = KL.Add(name="decoder_edge_n4add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_edge_n4upscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_edge_n4pooled")(n4_pooled)
    ])
    x = KL.Activation("relu")(x)

    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", activation="relu"),
                           name="decoder_edge_n4conv")(x)
    # 16x16
    x = KL.Add(name="decoder_edge_n3add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_edge_n3upscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_edge_n3pooled")(n3_pooled)
    ])
    x = KL.Activation("relu")(x)

    x = KL.TimeDistributed(KL.Conv2D(256, (3, 3), padding="same", activation="relu"),
                           name="decoder_edge_n3conv")(x)
    # 32x32
    x = KL.Add(name="decoder_edge_n2add")([
        KL.TimeDistributed(KL.Conv2DTranspose(256, (2, 2), strides=2),
                           name="decoder_edge_n2upscaled")(x),
        KL.TimeDistributed(copy_layer(), name="decoder_edge_n2pooled")(n2_pooled)
    ])
    x = KL.Activation("relu")(x)
...
def mrcnn_edge_loss_graph(target_edge, target_class_ids, pred_edge):
    """Mask binary cross-entropy loss for the masks head.
    ...
    # shape [batch*num, height, width]
    target_class_ids = K.reshape(target_class_ids, (-1,))
    edge_shape = tf.shape(target_edge)
    ...
    y_pred = tf.gather_nd(pred_edge, indices)
...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
    ...
    return image, image_meta, class_ids, bbox, mask, edge
...
def data_generator(dataset, config, shuffle=True, augment=False, augmentation=None,
    ...
    while True:
        try:
            ...
            image, image_meta, gt_class_ids, gt_boxes, gt_masks, gt_edge = \
            ...
            if b >= batch_size:
                inputs = [batch_images, batch_image_meta, batch_rpn_match, batch_rpn_bbox,
                          batch_gt_class_ids, batch_gt_boxes, batch_gt_masks, batch_gt_edge]
                outputs = []
...
class C26DMDE(object):
    """Encapsulates the C26DMDE model functionality.
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            rois, target_class_ids, target_bbox, target_mask, target_edge = \
                DetectionTargetLayer(config, name="proposal_targets")([
                    target_rois, input_gt_class_ids, gt_boxes, input_gt_masks, input_gt_edge])

            # Network Heads
            # TODO: verify that this handles zero padded ROIs
            mrcnn_class_logits, mrcnn_class, mrcnn_bbox = \
                fpn_classifier_graph(rois, class_feature_maps, input_image_meta, config.CLASSIFY_POOL_SIZE,
                                     config.NUM_CLASSES, train_bn=config.TRAIN_BN)

            mrcnn_mask = build_fpn_mask_graph(rois, mask_feature_maps, input_image_meta, config.MASK_POOL_SIZE,
                                              config.NUM_CLASSES, train_bn=config.TRAIN_BN)
            ...
            inputs = [input_image, input_image_meta,
                      input_rpn_match, input_rpn_bbox, input_gt_class_ids, input_gt_boxes, input_gt_masks, input_gt_edge]
            if not config.USE_RPN_ROIS:
                inputs.append(input_rois)
            outputs = [rpn_class_logits, rpn_class, rpn_bbox,
                       mrcnn_class_logits, mrcnn_class, mrcnn_bbox, mrcnn_mask, mrcnn_edge,
                       rpn_rois, output_rois,
                       rpn_class_loss, rpn_bbox_loss, class_loss, bbox_loss, mask_loss, edge_loss]
            model = KM.Model(inputs, outputs, name='C26DMDE')
            ...
            mrcnn_class_logits, mrcnn_class, mrcnn_bbox = \
                fpn_classifier_graph(rpn_rois, rpn_feature_maps, input_image_meta, config.CLASSIFY_POOL_SIZE,
                                     config.NUM_CLASSES, train_bn=config.TRAIN_BN)
            # Detections
            ...
            mrcnn_mask = build_fpn_mask_graph(detection_boxes, mask_feature_maps, input_image_meta,
            ...
            model = KM.Model([input_image, input_image_meta, input_anchors],
                             [detections, mrcnn_class, mrcnn_bbox, mrcnn_mask, mrcnn_edge,
    ...
    def compile(self, learning_rate, momentum):
        ...
        loss_names = [
            ...
            "mrcnn_mask_loss", "mrcnn_edge_loss"]
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        layer_regex = {
            ...
            "heads": r"(context\_.*)|(decoder\_.*)|(rpn\_.*)|(fpn\_.*)",
