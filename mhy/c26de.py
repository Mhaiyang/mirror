"""
  ...
  @Project : mirror
  @File    : c26de.py
  @Function: context_2-6 + decoder_edge. To prove that edge branch can boost the accuracy of detection
   through affect shared features.
...
class C26DE(object):
    """Encapsulates the C26DE model functionality.
    ...
    def build(self, mode, config):
        ...
        if mode == "training":
            ...
            outputs = [rpn_class_logits, rpn_class, rpn_bbox,
                       mrcnn_class_logits, mrcnn_class, mrcnn_bbox, mrcnn_edge,
                       rpn_rois, output_rois,
                       rpn_class_loss, rpn_bbox_loss, class_loss, bbox_loss, edge_loss]
            model = KM.Model(inputs, outputs, name='C26DE')
            ...
            model = KM.Model([input_image, input_image_meta, input_anchors],
                             [detections, mrcnn_class, mrcnn_bbox,
                              mrcnn_edge, rpn_rois, rpn_class, rpn_bbox],
                             name='C26DE')
    ...
    def compile(self, learning_rate, momentum):
        ...
        loss_names = [
            ...
            "mrcnn_class_loss", "mrcnn_bbox_loss", "mrcnn_edge_loss"]
